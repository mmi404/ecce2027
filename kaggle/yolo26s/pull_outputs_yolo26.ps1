# Pulls every YOLO26s train/eval kernel's output down from Kaggle and routes
# the files into the project's results/ layout, regardless of how the Kaggle
# CLI nests them under the staging directory.
#
...
$Owner   = "mmi404"
$RunIds  = @("e1_0_y26", "e1_1_y26", "e1_2_y26", "e2_0_y26", "e2_1_y26", "e2_2_y26", "rob_a_y26", "rob_b_y26")
