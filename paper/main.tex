...
\input{tables/mode_group_ci_table}
...
\input{tables/confusion_tables}

Table \ref{tab:confusion} breaks the recall gap down into misses vs.\ misclassifications.
